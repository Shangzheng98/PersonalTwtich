...
public class ApplicationConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.shangzheng.twitch.entity.db");
    ...
    public DataSource dataSource() {
        String RDS_ENDPOINT = "myporject-twitch-instance.cbwtxddsnrrh.us-east-1.rds.amazonaws.com";
        String USERNAME = "admin";
        String PASSWORD = "Jsz19980907";
